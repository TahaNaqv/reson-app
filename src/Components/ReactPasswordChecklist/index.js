...
const ReactPasswordChecklist = (_a) => {
    var { className, style, rules, value, valueAgain, minLength, maxLength, rtl, onChange, specialCharsRegex = /[~`¿¡!#$%\^&*€£@+÷=\-\[\]\\';,/{}\(\)|\\":<>\?\.\_]/g, messages = {} } = _a, remainingProps = __rest(_a, ["className", "style", "rules", "value", "valueAgain", "minLength", "maxLength", "rtl", "onChange", "specialCharsRegex", "messages"]);
    ...
    return (React.createElement("ul", { className: className, style: Object.assign({ margin: 0, padding: 0 }, style) }, enabledRules.map((rule) => {
